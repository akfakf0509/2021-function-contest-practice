<?php
    if(isset($_POST["ccbaKdcd"]) && isset($_POST["ccbaAsno"]) && isset($_POST["ccbaCtcd"]) && isset($_POST["ccmaName"]) && isset($_POST["crltsnoNm"]) && isset($_POST["ccbaMnm1"])) {
        ...
        $array = array($ccbaKdcd, $ccbaAsno, $ccbaCtcd, $ccbaCpno, $longitude, $latitude, $ccmaName, $crltsnoNm, $ccbaMnm1, $ccbaMnm2, $gcodeName, $bcodeName, $mcodeName, $scodeName, $ccbaQuan, $ccbaAsdt, $ccbaCtcdNm, $ccsiName, $ccbaLcad, $ccceName, $ccbaPoss, $ccbaAdmin, $ccbaCncl, $ccbaCndt, $name, $content);
