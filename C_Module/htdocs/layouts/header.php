...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/style.css?1">
...
<body>
    <nav class="nav container-xl p-1">
        <li class="nav-item ml-auto mr-1">
            <div class="dropdown">
                <button id="my-dropdown" class="btn btn-outline-primary dropdown-toggle py-1 px-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">한국어</button>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="sub-nav position-absolute bg-dark w-100 text-white">
                            <div class="container-xl">
                                ...
                                <ul>
                                    <li class="nav-item">
                                        <a href="cultural_status&bcodeName=전통 공연·예술" class="nav-link">전통 공연·예술</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="cultural_status&bcodeName=전통기술" class="nav-link">전통기술</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="cultural_status&bcodeName=전통지식" class="nav-link">전통지식</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="cultural_status&bcodeName=구전 전통 및 표현" class="nav-link">구전 전통 및 표현</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="cultural_status&bcodeName=전통 생활관습" class="nav-link">전통 생활관습</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="cultural_status&bcodeName=의례·의식" class="nav-link">의례·의식</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="cultural_status&bcodeName=전통 놀이·무예" class="nav-link">전통 놀이·무예</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <ul>
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-sub-nav">
                                            ...
                                            <li class="nav-item">
                                                <a href="year_calendar" class="nav-link">년간 공연 일정</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
